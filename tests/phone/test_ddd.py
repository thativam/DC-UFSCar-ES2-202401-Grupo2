...
class TestDDD(TestCase):
    def test_invalid_Number(self):
        ...
        for phone in invalid_phone:
            with self.subTest(phone=phone):
                self.assertIs(
                    return_region_from_ddd(phone), None
    ...
    def test_valid_ddd_and_find_regionRS(self):
        ...
        phone = "5335887651"
        self.assertEqual(
            return_region_from_ddd(phone), "Caxias do Sul e região"
        )
    ...
    def test_valid_ddd_and_find_regionSC(self):
        phone = "4840381307"
        self.assertEqual(
            return_region_from_ddd(phone), "Florianópolis e região"
        )
    ...
    def test_valid_ddd_and_find_regionPR(self):
        ...
        phone = "45911215368"
        self.assertEqual(
            return_region_from_ddd(phone), "Foz do Iguaçu e região"
        )

        phone = "46989326201"
        self.assertEqual(
            return_region_from_ddd(phone), "Francisco Beltrão e região"
        )
    ...
    def test_valid_ddd_and_find_regionSP(self):
        ...
        phone = "1256825073"
        self.assertEqual(
            return_region_from_ddd(phone), "São José dos Campos e região"
        )
        ...
        phone = "1633559157"
        self.assertEqual(
            return_region_from_ddd(phone), "Ribeirão Preto e região"
        )

        phone = "1749290450"
        self.assertEqual(
            return_region_from_ddd(phone), "São José do Rio Preto e região"
        )

        phone = "1833764233"
        self.assertEqual(
            return_region_from_ddd(phone), "Presidente Prudente e região"
        )
    ...
    def test_valid_ddd_and_find_regionRJ(self):
        ...
        phone = "2234441107"
        self.assertEqual(
            return_region_from_ddd(phone), "Região dos Lagos (Rio de Janeiro)"
        )

        phone = "2450980685"
        self.assertEqual(
            return_region_from_ddd(phone), "Região Serrana (Rio de Janeiro)"
        )

    def test_valid_ddd_and_find_regionMG(self):
        phone = "31928188258"
        self.assertEqual(
            return_region_from_ddd(phone), "Belo Horizonte e região"
        )
        ...
        phone = "3327950073"
        self.assertEqual(
            return_region_from_ddd(phone), "Teófilo Otoni e região"
        )
        ...
        phone = "3520597609"
        self.assertEqual(
            return_region_from_ddd(phone), "Poços de Caldas e região"
        )
    ...
    def test_valid_ddd_and_find_regionES(self):
        ...
        phone = "2848065584"
        self.assertEqual(
            return_region_from_ddd(phone), "Região Norte do Espírito Santo"
        )
